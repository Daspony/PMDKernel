...
# ============================================================================
# DEPRECATED — pipeline de generación de dataset basado en discos XY a Z fijo.
# La lógica del dataset se va a reemplazar; no extender ni apoyarse en este
# archivo para nuevos flujos. Conservado solo para reproducir corridas viejas.
# ============================================================================
@warn "utils/disco_DEPRECATED.jl: pipeline de dataset deprecado, va a ser reemplazado." maxlog=1
...
function simular_disco(z_mm::Real;
    ...
    @cuda threads=threads blocks=blocks _Bnu!(R, P, M, B, n_all, m)
